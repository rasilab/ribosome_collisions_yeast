...
- [[file:analysis/flow/hel2_asc1_mutants.md]] generates Fig. [[file:analysis/flow/figures/hel2_rescue.pdf][7C top panels]] and [[file:analysis/flow/figures/asc1_rescue.pdf][7C bottom panels]]. The P-values indicated in Fig. 7C in the manuscript are also calculated and displayed in this page. Note: The mKate2 channel measurement did not work properly in this experiment. Hence the YFP fluorescence is not normalized by mKate2 fluorescence in these figures.
...
Un-cropped western blot images corresponding to Fig. 5D, 7C are provided as =.png= images in [[file:data/western/]]. 
