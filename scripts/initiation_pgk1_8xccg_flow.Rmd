---
title: "Fluorescence of PGK1 WT reporters with 8xCCG / 8xCCA inserts and varying 5'UTR mutations"
...
annotations <- paste0(fcs_file_folder, '/sampleannotations.tsv') %>% 
  ...
  filter(gene == "pgk1" & numberofcodonrepeats == 8 | strain %in% c("schp19", "schp20", "schp15", "by4741")) %>% 
